...
public class Babycare extends JFrame implements ActionListener
{
	JComboBox<String> c;
	JButton b1,b2;
	JLabel l1,l2;
	...
	public Babycare()
	{
		...
		String string[]={"Pamperns Baby Dipper(Rs.325/24dipper pack )", "Pamperns Baby Dipper Small Size(Rs.660/46pcs. pack)","Lactrum Powder (Rs 400/50gm bottle)","Huggy Dry Dipper (Rs.50/5 dipper pack.)","Isomil Powder (Rs.400/400gm box)","Huggies Dry Dipper Small (Rs.100/10dipper pack)","Many Poko Pants(Rs700/56dipper pack)",};
