...
public class Paincare  extends JFrame implements ActionListener
{
	JComboBox<String> c;
	JButton b1,b2;
	JLabel l1,l2;
	...
	String string[]={"Voloini Gel (Rs.180/75gm tube)","Volini Spray (Rs.200/100gm tube)","Crocin Tablet (Rs 40/15tablet pack)","zandu Balm(Rs.80/25gm )","Moov (Rs.50/15gm)","Moov Spray (Rs.150/80gm spray)","Iodex(Rs.90/50gm tube)","Omnigel(Rs.8/100gm tube)","Tiger Balm(Rs.65/18gm tube"};
